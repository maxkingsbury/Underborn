...
draw_set_alpha(0.2);
draw_text(x + glow_offset, y + glow_offset, "Start");  // Bottom-right glow
draw_text(x - glow_offset, y + glow_offset, "Start");  // Bottom-left glow
draw_text(x + glow_offset, y - glow_offset, "Start");  // Top-right glow
draw_text(x - glow_offset, y - glow_offset, "Start");  // Top-left glow
draw_set_alpha(1);
