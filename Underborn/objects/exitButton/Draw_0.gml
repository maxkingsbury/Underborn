...
draw_set_alpha(0.3);
draw_text(x + glow_offset, y + glow_offset, "Exit");  // Bottom-right glow
draw_text(x - glow_offset, y + glow_offset, "Exit");  // Bottom-left glow
draw_text(x + glow_offset, y - glow_offset, "Exit");  // Top-right glow
draw_text(x - glow_offset, y - glow_offset, "Exit");  // Top-left glow
draw_set_alpha(1);
