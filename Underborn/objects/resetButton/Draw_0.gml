...
draw_set_alpha(0.3);
draw_text(x + glow_offset, y + glow_offset, "Reset Game");  // Bottom-right glow
draw_text(x - glow_offset, y + glow_offset, "Reset Game");  // Bottom-left glow
draw_text(x + glow_offset, y - glow_offset, "Reset Game");  // Top-right glow
draw_text(x - glow_offset, y - glow_offset, "Reset Game");  // Top-left glow
draw_set_alpha(1);
...
if (save_msg_timer > 0) {
    ...
    draw_text(display_get_gui_width() / 2, display_get_gui_height() - 60, "Save Slot Reset!");
}